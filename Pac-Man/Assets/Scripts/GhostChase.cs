...
public class GhostChase : MonoBehaviour
{
    ...
    IEnumerator SetNewDirection()
    {
        ...
        /* delay after getting new direction. if we don`t do this then openRay will be true and
        and the function will run more than necessary and ghost will get multiple decisions for directions */
